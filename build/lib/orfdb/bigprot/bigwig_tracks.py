...
class BwTracks:
    ...
    def extract_orf_bw_vector(self, orf_dict: Dict[str, str], parent_transcript_dict: Dict[str, str]) -> np.ndarray:
        ...
        gff_chrom_starts = orfdb.bigprot.misc.extract_numeric_vector(orf_dict['orf.chrom_starts'],
                                                                   remove_dangling_separators=True)
        gff_block_sizes = orfdb.bigprot.misc.extract_numeric_vector(orf_dict['orf.block_sizes'],
                                                                  remove_dangling_separators=True)
